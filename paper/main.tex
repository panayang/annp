...
We do not conclude that depth is unnecessary. Multi-hop is the only form of
depth this architecture has, an earlier version of this comparison was taken
while regime separation had collapsed, and the present one is on a single
source at one scale. Whether combinatorial addressing pays under a source that
rewards composition is untested.
