...
becomes their mixture and nothing is unusual relative to it, and every regime
collapses onto one class. Against a class's \emph{own}
...
argmax at all, so classes are allocated while every regime still routes to
one.
